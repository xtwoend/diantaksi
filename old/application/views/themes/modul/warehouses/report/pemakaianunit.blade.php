...
@section('header')
  <div class="header">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{URL::to('warehouse')}}">Warehouse</a> <span class="divider">/</span></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab1">
                  ...
                  {{ Form::open('warehouses/exppemakaianunit','POST', array( 'class'=>'form-inline' ))}}
                    <input type="hidden" id="kso_idx" name="kso_id">
...
$(function(){
  ...
  $('#view').live('click', function(){
    getPemakaianSparepart($('#date').val(), ksoid);
    return false;
  });
  ...
  getPemakaianSparepart = function(date, ksoid){
    $.ajax({
        type: 'POST',
        url: '{{ URL::base() }}'+'/warehouses/pemakaianunit',
        data: { date: date, ksoid: ksoid},
        dataType: 'json',
        success: function(response){
          console.log(response);
