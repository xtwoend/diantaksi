...
@section('header')
	<div class="header">
   			<h1 class="page-title">Permintaan Pembelian Spare Part</h1>
    </div>
...
<div class="block" id="formspk">
        <div class="block-heading">
            ...
            <a href="#widget-info" data-toggle="collapse">Form Permintaan Pembelian Spare Part</a>
        </div>
            ...
            <form action="POST" class="form-horizontal">
              <div class="span6">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" placeholder="No PP" value="{{ Pool::find(Auth::user()->pool_id)->pool_name }}" readonly>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="date">Ke</label>
                    <div class="controls">
                       {{ Form::select('supplier_id', $suppliers , $pp->supplier_id , array('id'=>'supplier_id')); }}
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <div class="input-append date" id="enddate" data-date="{{ $pp->tanggal_terima }}" data-date-format="yyyy-mm-dd">
                        <input name="tanggal_terima" id="tanggal_terima" class="input-small" type="text" value="{{ $pp->tanggal_terima }}">
                        <span class="add-on"><i class="icon-calendar"></i></span>
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      {{ Form::select('status', array('New Order', 'On Order', 'On Going', 'Finish') , $pp->status , array('id'=>'status')); }}
