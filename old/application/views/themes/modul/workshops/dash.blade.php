        ...
        <div id="tablewidget" class="block-body collapse in">
            <table class="table">
              ...
              <tbody>
              	@foreach($wos  as $wo)
                <tr>
                  <td>{{ HTML::link('workshops/editwo/'.$wo->id, $wo->wo_number) }}</td>
            ...
            <p><a href="{{ URL::to('workshops/wolist/1') }}">More...</a></p>
        </div>
    </div>
    <div class="block span6">
        ...
        <div id="widget1container" class="block-body collapse in">
          <table class="table">
            ...
            <p><a href="{{ URL::to('workshops/wolist/2') }}">More...</a></p>
        </div>
    </div>
</div>
        ...
        <div id="tablewidget" class="block-body collapse in">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ HTML::link('workshops/editwo/'.$wp->id, $wp->wo_number) }}</td>
            ...
            <p><a href="{{ URL::to('workshops/wolist/4') }}">More...</a></p>
        </div>
    </div>
    <div class="block span6">
        ...
        <div id="widget1container" class="block-body collapse in">
          <table class="table">
            ...
            <p><a href="{{ URL::to('workshops/wolist/3') }}">More...</a></p>
        </div>
    </div>
</div>
@endsection