         	...
         	<table class="table table-condensed table-striped">
         		<thead>
         			<tr>
         				...
         				<th><a href="{{ URL::to('workshops/wolist/'.$status_id.'?sort=taxi_number'.$querystr) }}">Nomor Body</a></th>
         				<th><a href="{{ URL::to('workshops/wolist/'.$status_id.'?sort=inserted_date_set'.$querystr) }}">Tanggal</a></th>
                <th><a href="{{ URL::to('workshops/wolist/'.$status_id.'?sort=mechanic'.$querystr) }}">Mekanik</a></th>
                <th>Komplain</th>
         				<th>KM Masuk</th>
                <th>Action</th>
         			</tr>
                ...
                @foreach($wos->results as $wo)
                  ...
                  <td>{{ $wo->complaint }}</td>
	            		<td>{{ $wo->km }}</td>
	            		<td>
	            			<a class="btn btn-success btn-mini" href="{{ URL::to('workshops/woanalisis/'.$wo->id) }}"><i class="icon-edit icon-white"></i></a>  
                  </td>
	            	</tr>
                <?php $no++; ?>
	           		@endforeach
