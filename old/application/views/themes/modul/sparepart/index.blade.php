         	...
         	<table class="table table-condensed table-striped">
         		<thead>
         			<tr>
         				...
         				<th><a href="{{ URL::to('sparepart?sort=name_sparepart'.$querystr) }}">Nama Part</a></th>
         				<th><a href="{{ URL::to('sparepart?sort=part_number'.$querystr) }}">Nomor Part</a></th>
                <th>Part ID</th>
         				<th>Moving Part</th>
         				<th><a href="{{ URL::to('sparepart?sort=sp_categories_id'.$querystr) }}">Category</a></th>
         				<th style="text-align: center;"><a href="{{ URL::to('sparepart?sort=base_price'.$querystr) }}">Harga Beli</a></th>
         				<th style="text-align: center;"><a href="{{ URL::to('sparepart?sort=price'.$querystr) }}">Harga Jual</a></th>
         				<th>Satuan</th>
         				<th>Action</th>
         			</tr>
         		</thead>
