...
@section('header')
  <div class="header">
        <h1 class="page-title">Kartu Kontrol Armada Selesai KSO</h1>
  </div>
    <ul class="breadcrumb">
        <li><a href="{{URL::to('admin/dashboard')}}">Home</a> <span class="divider">/</span></li>
        <li class="active">Kartu Kontrol Armada Selesai KSO</li>
    </ul>
@endsection
...
$(function () {
      ...
      function findById(id) {
        ...
        $.ajax({
          type: 'GET',
          url: rootURL + '/findbyIdFleetkso/' + id,
          dataType: "json",
      ...
      function renderList(data) {
        ...
        $.each(list, function(index, fleet) {
          $('#driverLists').append('<li><a href="#" data-identity="' + fleet.id + '">'+fleet.taxi_number+' ( ' + fleet.kso_number+ ' ) '+'</a></li>');
        });
      }
