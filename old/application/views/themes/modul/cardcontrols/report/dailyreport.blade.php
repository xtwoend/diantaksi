...
<script type="text/javascript">
      ...
      function viewGrid(dateSchedule,shift_id) {
               ...
               grid.jqGrid({
                    ...
                    colNames:['NO','NIP', 'NAMA','BODY', 'STATUS OPS','WAKTU MASUK', 'WAKTU STOR', 'SHIFT','SETORAN MURNI','TAB S-PART','DENDA','DP S-PART','BAYAR KS','BAYAR S-PART','BAYAR DP-KSO','BAYAR HUT-LAMA','STIKER BANDARA','CUCI','LAKA','HARUS DISETOR','POTONGAN','SETOR CASH','KETEKORAN', 'SETORAN OPS','OPERATOR'],
                    colModel:[
                        ...
                        {name:'finance_time',index:'finance_time', width:125 ,search:true, fixed: true , frozen:true},
                        {name:'shift_id',index:'shift_id', width:70 ,search:true, fixed: true , frozen:true},
                        ...
                        {name:'finance_check_user_id',index:'finance_check_user_id', width:100 ,search:false ,fixed: true, },
                    ],
                    pager: "#jqGridPager01",
                    viewrecords: true,
