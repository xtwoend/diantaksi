...
<script type="text/javascript">
      ...
      function viewGrid(dateSchedule,shift_id) {
               ...
               grid.jqGrid({
                    ...
                    colNames:['NO','NIP', 'NAMA','BODY', 'STATUS OPS','WAKTU MASUK', 'SHIFT','SETORAN MURNI','TAB S-PART','DENDA','DP S-PART','BAYAR KS','BAYAR S-PART','BAYAR DP-KSO','BAYAR HUT-LAMA','STIKER BANDARA','CUCI','LAKA','HARUS DISETOR','POTONGAN','SETOR CASH','KETEKORAN', 'SETORAN OPS'],
                    colModel:[
