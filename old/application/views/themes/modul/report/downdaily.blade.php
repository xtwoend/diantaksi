...
@section('header')
  <div class="header">
        <h1 class="page-title">Grafik Ketekoran Operasi Dalam 1 Bulan</h1>
  </div>
        
    <ul class="breadcrumb">
        <li><a href="{{URL::to('admin/dashboard')}}">Home</a> <span class="divider">/</span></li>
        <li class="active">Statistik Ketekoran harian</a></li>
    </ul>
@endsection
...
$(function () {
      ...
      function findAll(date) {
        ...
        $.ajax({
          type: 'GET',
          url: rootURL + '/datadowndaily/' + date,
          ...
          success: function (data) {
              $('#container').highcharts({
                  ...
                  title: {
                      text: 'Ketekoran Pendapatan Dalam 1 Bulan',
                      x: -20 //center
                  },
                  xAxis: {
                  ...
                  yAxis: {
                      title: {
                          text: 'Total Ketekoran Operasi (1.000.000)'
                      },
                      plotLines: [{
                          value: 0,
                          width: 1,
