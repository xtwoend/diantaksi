            ...
            <?php $no=1; ?>
              <tbody>
                ...
                <tr>
                  ...
                  <td>@if($out->print_out_time==1) 
                      {{ User::find($out->otorisasi_user_id)->fullname }}
                      Ket : {{ $out->keterangan }} 
                      @endif
                    </td>
                </tr>
