...
@section('header')
  <div class="header">
        <h1 class="page-title">Grafik Pendapatan Operasi Dalam 1 Tahun</h1>
  </div>
...
@section('content')
    ...
    <div class="block">
        <div class="block-heading">
            <a href="#widgetGroup1" data-toggle="collapse">Statistik Tahunan</a>       
        </div>
...
var rootURL = '{{ URL::base().'/reportsnew' }}';
        ...
        $.ajax({
          ...
          success: function (data) {
              $('#container').highcharts({
                  ...
                  title: {
                      text: 'Setoran Operasi Dalam 1 Tahun',
                      x: -20 //center
                  },
                  xAxis: {
