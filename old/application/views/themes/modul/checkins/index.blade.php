        ...
        <div class="block-body collapse in" id="widgetGroup1">
         ...
         <div class="row-fluid">
            <div class="span3">
             ...
             <div class="span9">
               JIKA INGIN MENAMBAHKAN DATA SETELAH ARMADA CHECK-IN SILAHKAN MASUKAN NOMOR BODY DI KOLOM SEARCH LALU KLIK ICON SREACH DI SEBELAHNYA
                    LALU MASUKAN DATA DAN SIMPAN
             </div>
          </div>
        </div>
</div>
              ...
              <div class="tab-pane active" id="tab1">
                ...
                <table class="table table-condensed table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" id="status_operasi" name="status_operasi" disabled> 
                      <input type="hidden" id="statusopval" name="operasi_status_id" >
                    </td>
                  </tr>
                 
                  <tr>
                    <td>Status Checkin</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td><input type="text" id="kmfleet" name="kmfleet" required tabindex="1"></td>
                  </tr>
                  <tr>
                    <td>RIT</td>
                    <td><input type="text" id="rit" name="rit" required tabindex="2"></td>
                  </tr>
                  <tr>
                    <td>Income KM</td>
                    <td><input type="text" id="incomekm" name="incomekm" required tabindex="3"></td>
                  </tr>
                  <tr>
                    <td>Check In Time</td>
               ...
               <div id="checkinstep1"><button class="btn btn-info pull-right" id="checkinstep1" tabindex="4">Chekin Fleet <i class="icon-chevron-right"></i></button></div>
              <br>
              <br>
              </div>
               {{-- Check document --}}
...
<script type="text/javascript">
      ...
      function renderDetails(info) {
        ...
        $('#status_operasi').val(info.statusops);
        $('#statusopval').val(info.statusopsval);
