...
<script type="text/javascript">
      ...
      function viewGrid(dateSchedule) {
               ...
               grid.jqGrid({
                    ...
                    colNames:['NO','BODY', 'BS' ,'SETORAN MURNI','TAB S-PART','DENDA','DP S-PART','BAYAR KS','BAYAR S-PART','BAYAR DP-KSO','BAYAR HUT-LAMA','STKR BANDARA & KEAMANAN','CUCI','LAKA','HARUS DISETOR','POTONGAN','SETOR CASH','KETEKORAN', 'SETORAN OPS','SELISI KS'],
                    colModel:[
