...
<script type="text/javascript">
      ...
      function viewGrid(dateSchedule, startdateops, shift_id) {
                ...
                grid.jqGrid({
                    ...
                    rowNum: 40,
                    rowList: [40],
                    colNames:['NO','TANGGAL OPERASI','SHIFT','SETORAN MURNI','TAB S-PART','DENDA','DP S-PART','BAYAR KS','BAYAR S-PART','BAYAR DP-KSO','BAYAR HUT-LAMA','STKR BANDARA & KEAMANAN','CUCI','LAKA','HARUS DISETOR','POTONGAN','SETOR CASH','KETEKORAN', 'SETORAN OPS'],
                    colModel:[
