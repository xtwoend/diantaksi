        ...
        <div class="block-body collapse in" id="widgetGroup1">
          ...
          <div class="form-inline">
              <div class="input-append date" id="datepicker" data-date="{{ date('Y-m-d') }}" data-date-format="yyyy-mm-dd">
                  <input name="date" id="date" class="input-small" type="text" value="{{ date('Y-m-d') }}" readonly>
        ...
        <div class="block-body collapse in" id="widget-info">
          ...
          <div class="tabbable">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#tab5" data-toggle="tab">DP Armada</a></li>
...
var currentInfo;
var time_peroses = false;

$(function () {
        /* Desable Date Picker untuk tidak bisa memperoses di malah hari
      ...
      function findAll(dateSchedule) {
        ...
        $.ajax({
          type: 'GET',
          url: rootURL + '/blockingdriver/' + dateSchedule,
      ...
      function renderList(data) {
        ...
        $.each(list, function(index, driver) {
          $('#armadaOnBlocking').append('<li><a href="#" data-identity="' + driver.id + '">('+driver.nip+') '+ driver.name +'</a></li>');
        });
      }
