...
-- Dumping structure for view db2.financial_report_monthly_driver_status
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `financial_report_monthly_driver_status` (
...
DROP VIEW IF EXISTS `financial_report_monthly_driver_status`;
CREATE VIEW `financial_report_monthly_driver_status` AS select 
cin.*,
cf.checkin_id,
